...
<div class="md:flex block items-center justify-between my-6 page-header-breadcrumb">
  <div>
      <h4 class="mb-0 text-defaulttextcolor font-medium">Hola, !</h4>
      <p class="-mt-[0.2rem] mb-0 text-textmuted">Monitoreo de ventas.</p>
  </div>
...
<div class="grid grid-cols-12 gap-x-6">
  <div class="xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
      ...
      <div class="px-4 pt-4 pb-2">
          <div>
          <h6 class="mb-3 text-[.75rem] font-medium text-fixed-white">Ventas de ahora ({{now()}})</h6>
          </div>
          <div class="pb-0 mt-0">
          <div class="flex">
              <div>
              <h4 class="font-bold text-[1.25rem] text-fixed-white">$5,74.12</h4>
              <p class="mb-0 text-[.75rem] text-fixed-white opacity-[0.7]">Comparado de la semana anterior</p>
              </div>
  ...
  <div class="xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
      ...
      <div class="px-4 pt-4 pb-2">
          <div>
          <h6 class="mb-3 text-[.75rem] font-medium text-fixed-white">Productos vendidos</h6>
          </div>
          <div class="pb-0 mt-0">
          <div class="flex">
              <div>
              <h4 class="text-[1.25rem] font-bold text-fixed-white">$1,230.17</h4>
              <p class="mb-0  text-[.75rem] text-fixed-white opacity-[0.7]">Comparado con la semana anterior</p>
              </div>
              <span class="float-end my-auto ms-auto">
  ...
  <div class="xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
      <div class="box  overflow-hidden sales-card bg-success-gradient !rounded-sm">
          <div class="px-4 pt-4 pb-2">
              <div>
              <h6 class="mb-3 text-[.75rem] font-medium text-fixed-white">Cotizaciones por autorizar</h6>
              </div>
              <div class="pb-0 mt-0">
              <div class="flex">
                  <div>
                  <h4 class="text-[1.25rem] font-bold text-fixed-white">56</h4>
                  <p class="mb-0 text-[.75rem] text-fixed-white opacity-[0.7]">Se requiere autorizar por el administrador</p>
                  </div>
              </div>
              </div>
          </div>
  ...
  <div class="xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
      <div class="box  overflow-hidden sales-card bg-warning-gradient !rounded-sm">
          <div class="px-4 pt-4 pb-2">
              <div>
              <h6 class="mb-3 text-[.75rem] font-medium text-fixed-white">Cotizaciones realizadas</h6>
              </div>
              <div class="pb-0 mt-0">
              <div class="flex">
                  <div>
                  <h4 class="text-[1.25rem] font-bold text-fixed-white">531</h4>
                  <p class="mb-0 text-[.75rem] text-fixed-white opacity-[0.7]">Comparada con la semana pasada</p>
                  </div>
                  <span class="float-end my-auto ms-auto">
                  <i class="fas fa-arrow-circle-down text-fixed-white"></i>
                  <span class="text-fixed-white opacity-[0.7]"> -1%</span>
                  </span>
              </div>
              </div>
          </div>
